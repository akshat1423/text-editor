...
import ImageFlowPanel from './components/ImageFlowPanel';
...
const HeaderSection: React.FC<{ controller: EditorController }> = ({ controller }) => {
  const {
    settings,
    title,
    setTitle,
...
const EditorSurface: React.FC<{ controller: EditorController }> = ({ controller }) => {
  const {
    settings,
    editorRef,
    isGenerating,
...
const SlashMenuOverlay: React.FC<{ controller: EditorController }> = ({ controller }) => {
...
const ErrorToast: React.FC<{ controller: EditorController }> = ({ controller }) => {
...
const App: React.FC = () => {
  ...
  const { settings, selectedFont, showSettings, setShowSettings, setSettings, setSelectedFont, state, safeCycle, isReviewing } = controller;
